...
enum ssctl_ssr_event_enum_type {
	...
	/*ZTE_MODIFY, add leds control driver, start*/
	...
	/*ZTE_MODIFY, add leds control driver, end*/
...
int sysmon_send_led_cmd(enum ssctl_ssr_event_enum_type event, const char *tx_buf);//ZTE-MODIFY wanghaifei 20141022, add for led
#else
