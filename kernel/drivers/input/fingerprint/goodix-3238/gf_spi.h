...
#define GF_NAV_INPUT_UP			KEY_FINGER_UP//KEY_UP
#define GF_NAV_INPUT_DOWN		KEY_FINGER_DOWN//KEY_DOWN
#define GF_NAV_INPUT_LEFT		KEY_FINGER_LEFT//KEY_LEFT
#define GF_NAV_INPUT_RIGHT		KEY_FINGER_RIGHT//KEY_RIGHT
