 ...
 */
#define FTS_UPGRADE_FW_APP                      "include/firmware/FT3327_Helitai_app.i"

/*
 * if FTS_GET_VENDOR_ID_NUM >= 2, fw corrsponding with FTS_VENDOR_2_ID
 * define your own fw_app, the sample one is invalid
 */
#define FTS_UPGRADE_FW2_APP                     "include/firmware/FT3327_Lianchuang_app.i"
