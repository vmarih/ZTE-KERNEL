...
struct fts_upgrade_fun
{
	...
	int (*tpd_get_version_etc)(struct i2c_client *client, int * chipid_in_chip, 	int *fwver_in_chip, int *module_id_in_chip);
	int (*tpd_firmware_upgrade)(struct i2c_client *client, unsigned char * pbt_buf, unsigned int size, unsigned int force_upg);
};
