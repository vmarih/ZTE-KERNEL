...
#define FTS_DEBUG(fmt, args...) printk(KERN_NOTICE "[FTS][%s]"fmt"\n", __func__, ##args)
#else
#define FTS_DEBUG(fmt, args...)
//printk(KERN_DEBUG "[FTS]"fmt"\n", ##args)
#endif

#define FTS_FUNC_ENTER() printk(KERN_NOTICE "[FTS]%s: Enter\n", __func__)
//#define FTS_FUNC_EXIT()  printk(KERN_NOTICE "[FTS]%s: Exit(%d)\n", __func__, __LINE__)
