...
void UpDateCSInfo(struct FT8006 *g_FT8006)
{
    ...
    csMarterTx = %d, csMasterRx = %d, csSlaveTx = %d, csSlaveRx = %d.", g_FT8006->m_csInfo->csType, g_FT8006->m_csInfo->csDirection, g_FT8006->m_csInfo->csS0Role, g_FT8006->m_csInfo->csMasterAddr, g_FT8006->m_csInfo->csSalveAddr, g_FT8006->m_csInfo->csMarterTx, g_FT8006->m_csInfo->csMasterRx, g_FT8006->m_csInfo->csSlaveTx, g_FT8006->m_csInfo->csSlaveRx);
