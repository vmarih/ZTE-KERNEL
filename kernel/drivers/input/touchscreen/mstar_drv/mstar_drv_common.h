...
#define DEVICE_DRIVER_RELEASE_VERSION   ("5.7.0.7")
...
#define MSTAR_TEST_DBG(fmt, args...) do {printk(KERN_ERR "[MSTAR] [TEST]%s. line: %d.  "fmt"\n",  __FUNCTION__, __LINE__, ##args);} while (0)
#define MSTAR_TEST_FUNC_ENTER() printk(KERN_ERR "[MSTAR][TEST]%s: Enter(%d)\n", __func__, __LINE__)
#define MSTAR_TEST_FUNC_EXIT()  printk(KERN_ERR "[MSTAR][TEST]%s: Exit(%d)\n", __func__, __LINE__)
#endif
