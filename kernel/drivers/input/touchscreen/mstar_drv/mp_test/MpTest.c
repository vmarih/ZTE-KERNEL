...
//    int i;
	...
	ptMutualMpTest->Goldensample_CH_0 = (double *)kcalloc(MAX_MUTUAL_NUM, sizeof(double), GFP_KERNEL);
	nSize = 0;
	nSize = IniGetDoubleArray("[RULES]","Golden_CH_0",ptMutualMpTest->Goldensample_CH_0);
#else
    ptMutualMpTest->Goldensample_CH_0 = (int *)kcalloc(MAX_MUTUAL_NUM, sizeof(int), GFP_KERNEL);
	nSize = 0;
	//nSize = IniGetDoubleArray("[RULES]","Golden_CH_0",ptMutualMpTest->Goldensample_CH_0);	
...
#ifndef DISABLE_DOUBLE
	ptMutualMpTest->Goldensample_CH_0_Max = (double *)kcalloc(MAX_MUTUAL_NUM, sizeof(double), GFP_KERNEL);
	ptMutualMpTest->Goldensample_CH_0_Max_Avg = (double *)kcalloc(MAX_MUTUAL_NUM, sizeof(double), GFP_KERNEL);
	ptMutualMpTest->Goldensample_CH_0_Min = (double *)kcalloc(MAX_MUTUAL_NUM, sizeof(double), GFP_KERNEL);
	ptMutualMpTest->Goldensample_CH_0_Min_Avg = (double *)kcalloc(MAX_MUTUAL_NUM, sizeof(double), GFP_KERNEL);
#else
	ptMutualMpTest->Goldensample_CH_0_Max = (int *)kcalloc(MAX_MUTUAL_NUM, sizeof(int), GFP_KERNEL);
	ptMutualMpTest->Goldensample_CH_0_Max_Avg = (int *)kcalloc(MAX_MUTUAL_NUM, sizeof(int), GFP_KERNEL);
	ptMutualMpTest->Goldensample_CH_0_Min = (int *)kcalloc(MAX_MUTUAL_NUM, sizeof(int), GFP_KERNEL);
	ptMutualMpTest->Goldensample_CH_0_Min_Avg = (int *)kcalloc(MAX_MUTUAL_NUM, sizeof(int), GFP_KERNEL);
#endif
...
int Msg28xxStartMPTest(void)
{
	...
	if(ptMutualMpTestResult->nShortResult & ptMutualMpTestResult->nOpenResult )
		g_mstar_tptest_result = 0;
	else
		g_mstar_tptest_result = 1;

	printk("g_mstar_tptest_result = %d\n", g_mstar_tptest_result);
