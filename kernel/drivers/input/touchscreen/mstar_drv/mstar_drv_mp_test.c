...
//    u8 nDrvOpening = 0;
    ...
    u16 *pOnCellNormalTestResultCheck = NULL;
    u16 nFwVer = 0;
	u16 nScanMode = 0;
    ...
    pOnCellNormalTestResultCheck = kzalloc(sizeof(u16) * MUTUAL_IC_MAX_MUTUAL_NUM, GFP_KERNEL);
_RETRY_OPEN:
    DrvPlatformLyrTouchDeviceResetHw();
    ...
    if (_gMsg28xx_PATTERN_TYPE == 5)
    {
        nRetVal = _DrvMpTestItoOpenTestMsg28xxOnCellOpenJudge(0, aOnCellNormalTestResult, pOnCellNormalTestResultCheck/*, nDrvOpening*/);
    }
    else
    {
...
ITO_TEST_END:    
    ...
    DrvPlatformLyrEnableFingerTouchReport();
    kfree(pOnCellNormalTestResultCheck);
    return nRetVal;
}
