...
static int get_prop_capacity(struct fg_chip *chip)
{
	...
	pr_debug("use_last_soc=%d, last_soc=%d, charge_full=%d, soc_empty=%d, health=%d, status=%d\n",
...
#if 0 //ZTE_MODIFY BY WANGBIN FOR offcharge
...
/* ZTE_MODIFY by DingXuehua, begin */
